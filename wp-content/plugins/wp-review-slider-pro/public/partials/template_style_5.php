...
foreach ( $rowarray[$x] as $review ) 
{
		...
		//star number --------------------------------------
		$starfile_burl_logo_array = $templateclass->wprevpro_get_star_logo_burl($review,$imgs_url,$currentform[0],"t5");
	...
	if($currentform[0]->display_num>0){
		...
		//$tempmasonrydiv =' wprevpro_t5_DIV_1'.$tempwidget.' w3_wprs-col l'.$perrow.' m6';
		if(	$currentform[0]->display_masonry=="yes"){
			$tempmasonrydiv ='wprs_masonry_item wprevpro_t5_DIV_1'.$tempwidget.' ';
		}
