...
(function( $ ) {
	...
	$(function(){
		...
		function changepreviewhtml(){
			...
			var formstyle = '<style>'+locstyle+customcss+'</style>';
		...
		function getfloatdata(){
			...
			if($('input[type=radio][name=wprevpro_float_type]:checked').val() == 'badge'){
				var wtfloatid = $( "#wprevpro_badge_id" ).val();
			} else if($('input[type=radio][name=wprevpro_float_type]:checked').val() == 'reviews'){
