 ...
 */
	...
	if(isset($_GET['forcerecal'])){
		if($_GET['forcerecal']=='yes'){
			...
			$tempquery = "SELECT pageid FROM ".$reviews_table_name." WHERE pageid IS NOT NULL GROUP BY pageid";
			$temppageids = $wpdb->get_col($tempquery);
			if(count($temppageids)>0){
				//loop array and calculate
				//print_r($temppageids);
				foreach ($temppageids as &$pageid) {
					$plugin_admin_hooks->updatetotalavgreviews('', $pageid, '', '' );
				}
			...
			$dbmsg = '<div id="setting-error-wprevpro_message" class="updated settings-error notice is-dismissible"><p><strong>'.__('No review page ids found. Please download or insert reviews first.', 'wp-review-slider-pro').'</strong></p><button type="button" class="notice-dismiss"><span class="screen-reader-text">'.__('Dismiss this notice.', 'wp-review-slider-pro').'</span></button></div>';
			}
		}
		...
		<tbody>
			...
			<tr class="wprevpro_row">
				...
				<td><div id="divtemplatestyles">
					...
					<label for="wprevpro_badge_type1-radio"><?php _e('Post or Page', 'wp-review-slider-pro'); ?></label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
...
<a id="wprevpro_btn_pickpages" class="button dashicons-before dashicons-yes "><?php _e('Select Locations', 'wp-review-slider-pro'); ?></a>
					<?php
				...
				?>
								...
								<div class="wprevpre_temp_label_row wprevpre_bgcolor1 bc1div">
									<input type="text" data-alpha="true" value="<?php echo $badge_misc_array['bgcolor1']; ?>" name="wprevpro_badge_misc_bgcolor1" id="wprevpro_badge_misc_bgcolor1" class="my-color-field" />
								</div>
								<div class="wprevpre_temp_label_row wprevpre_bgcolor2 bc2div">
									<input type="text" data-alpha="true" value="<?php echo $badge_misc_array['bgcolor3']; ?>" name="wprevpro_badge_misc_bgcolor3" id="wprevpro_badge_misc_bgcolor3" class="my-color-field" />
								</div>
								<div class="wprevpre_temp_label_row wprevpre_bgcolor2 bcdiv">
									<input type="text" data-alpha="true" value="<?php echo $badge_misc_array['bgcolor2']; ?>" name="wprevpro_badge_misc_bgcolor2" id="wprevpro_badge_misc_bgcolor2" class="my-color-field" />
								</div>
								<div class="wprevpre_temp_label_row wprevpre_starcolor rowstarcolor">
									<input type="text" value="<?php echo $badge_misc_array['starcolor']; ?>" name="wprevpro_badge_misc_starcolor" id="wprevpro_badge_misc_starcolor" class="my-color-field" />
								</div>
								<div class="wprevpre_temp_label_row wprevpre_tcolor1 tc1div">
									<input type="text" value="<?php echo $badge_misc_array['tcolor1']; ?>" name="wprevpro_badge_misc_tcolor1" id="wprevpro_badge_misc_tcolor1" class="my-color-field" />
								</div>
								<div class="wprevpre_temp_label_row wprevpre_tcolor2">
									<input type="text" value="<?php echo $badge_misc_array['tcolor2']; ?>" name="wprevpro_badge_misc_tcolor2" id="wprevpro_badge_misc_tcolor2" class="my-color-field" />
								</div>
								<div class="wprevpre_temp_label_row wprevpre_tcolor3">
									<input type="text" value="<?php echo $badge_misc_array['tcolor3']; ?>" name="wprevpro_badge_misc_tcolor3" id="wprevpro_badge_misc_tcolor3" class="my-color-field" />
								</div>
								<div class="wprevpre_temp_label_row">
						  ...
						  <div class="w3_wprs-col s12">
							...
							<div class="w3_wprs-col s9">
								...
								<div class="wprevpre_temp_label_row wprevpre_slbgcolor1">
									<input type="text" data-alpha="true" value="<?php echo $badge_misc_array['slbgcolor1']; ?>" name="wprevpro_badge_misc_slbgcolor1" id="wprevpro_badge_misc_slbgcolor1" class="my-color-field updatesliderinput" />
								</div>
								<div class="wprevpre_temp_label_row wprevpre_slbgcolor1">
									<input type="text" data-alpha="true" value="<?php echo $badge_misc_array['slbordercolor1']; ?>" name="wprevpro_badge_misc_slbordercolor1" id="wprevpro_badge_misc_slbordercolor1" class="my-color-field updatesliderinput" />
								</div>
								<div class="wprevpre_temp_label_row slwidthdiv">
									<input type="number" data-alpha="true" min="0" value="<?php echo $badge_misc_array['slborderwidth']; ?>" name="wprevpro_badge_misc_slborderwidth" id="wprevpro_badge_misc_slborderwidth" class="updatesliderinput" style="width: 45px;" />
								</div>
								<div class="wprevpre_temp_label_row slwidthdiv hideforpopup" <?php if($badge_misc_array['slidelocation']=='top' ||$badge_misc_array['slidelocation']=='bottom'){echo "style='display:none;'";} ?> <?php if($badge_misc_array['onclickaction']=='popup'){echo "style='display:none;'";} ?>>
									<input type="number" data-alpha="true" value="<?php echo $badge_misc_array['slwidth']; ?>" name="wprevpro_badge_misc_slwidth" id="wprevpro_badge_misc_slwidth" class="marginpaddinginput updatesliderinput" />
								</div>
								<div class="wprevpre_temp_label_row slheightdiv hideforpopup" <?php if($badge_misc_array['slidelocation']=='left' ||$badge_misc_array['slidelocation']=='right'){echo "style='display:none;'";} ?> <?php if($badge_misc_array['onclickaction']=='popup'){echo "style='display:none;'";} ?>>
									<input type="number" data-alpha="true" value="<?php echo $badge_misc_array['slheight']; ?>" name="wprevpro_badge_misc_slheight" id="wprevpro_badge_misc_slheight" class="marginpaddinginput updatesliderinput" />
								</div>
								<div class="wprevpre_temp_label_row hideforpopup" <?php if($badge_misc_array['onclickaction']=='popup'){echo "style='display:none;'";} ?>>
									<div class="wprevpre_temp_label_row">
									<?php _e('Top', 'wp-review-slider-pro'); ?>:<input type="number" data-alpha="true" value="<?php echo $badge_misc_array['slpadding-top']; ?>" name="wprevpro_badge_misc_slpadding-top" id="wprevpro_badge_misc_slpadding-top" class="marginpaddinginput updatesliderinput" /> 
									<?php _e('Right', 'wp-review-slider-pro'); ?>:<input type="number" data-alpha="true" value="<?php echo $badge_misc_array['slpadding-right']; ?>" name="wprevpro_badge_misc_slpadding-right" id="wprevpro_badge_misc_slpadding-right" class="marginpaddinginput updatesliderinput" />
									</div>
									<div class="wprevpre_temp_label_row">
									<?php _e('Bottom', 'wp-review-slider-pro'); ?>:<input type="number" data-alpha="true" value="<?php echo $badge_misc_array['slpadding-bottom']; ?>" name="wprevpro_badge_misc_slpadding-bottom" id="wprevpro_badge_misc_slpadding-bottom" class="marginpaddinginput updatesliderinput" /> 
									<?php _e('Left', 'wp-review-slider-pro'); ?>:<input type="number" data-alpha="true" value="<?php echo $badge_misc_array['slpadding-left']; ?>" name="wprevpro_badge_misc_slpadding-left" id="wprevpro_badge_misc_slpadding-left" class="marginpaddinginput updatesliderinput" />
									</div>
								</div>
							</div>
						  </div>
