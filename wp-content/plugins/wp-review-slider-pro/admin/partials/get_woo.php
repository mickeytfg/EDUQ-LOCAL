 ...
 */
    ...
    if (isset($_GET['settings-updated'])) {
		...
		if($options['woo_radio_sync']=='yes'){
			add_settings_error('woo-radio', 'wppro_message', __('Settings Saved. Your WooCommerce reviews should now show up on the Review List page below. ', 'wp-review-slider-pro'), 'updated');
		} else {
