 ...
 */
	...
	if (isset($_POST['wprevpro_submittemplatebtn'])){
		...
		$templatemiscarray['pagefilterlist'] = $this->wprev_commastrtojson($templatemiscarray['pagefilterlist']);	
		$templatemiscarray['catfilterlist'] = $this->wprev_commastrtojson($templatemiscarray['catfilterlist']);
...
<form name="newtemplateform" id="newtemplateform" action="?page=wp_pro-float" method="post" onsubmit="return validatefloatForm()">
		...
		<tbody>
			...
			<tr class="wprevpro_row">
				...
				<td><div id="divtemplatestyles">
					...
					<p class="description">
					<?php _e('Do you want to create a floating badge or review slider?', 'wp-review-slider-pro'); ?></p>
				</td>
			</tr>
			<tr class="wprevpro_row badgeselectrow" <?php if($currentfloat->float_type=='reviews'){echo "style='display:none;'";}?>>
				<th scope="row">
			...
			<tr class="wprevpro_row reviewtemplateselectrow" <?php if($currentfloat->float_type=='badge'){echo "style='display:none;'";}?>>
				<th scope="row">
					<?php _e('Choose Review Template:', 'wp-review-slider-pro'); ?>
				</th>
				<td>
				<?php
					//get list of badges and create select list
					...
					if(count($reviewlist)>0){
						//check for currently selected
						$tempselected ='';
						if($currentfloat->float_type=='reviews'){
							$tempselected = $currentfloat->content_id;
						}
				?>
						  ...
						  <div class="w3_wprs-col s12">
							...
							<div class="w3_wprs-col s9">
								...
								<div class="wprevpre_temp_label_row wprevpre_bgcolor1">
									<input type="text" data-alpha="true" value="<?php echo $float_misc_array['bgcolor1']; ?>" name="wprevpro_float_misc_bgcolor1" id="wprevpro_float_misc_bgcolor1" class="my-color-field" />
								</div>
								<div class="wprevpre_temp_label_row wprevpre_bgcolor1">
									<input type="text" data-alpha="true" value="<?php echo $float_misc_array['bordercolor1']; ?>" name="wprevpro_float_misc_bordercolor1" id="wprevpro_float_misc_bordercolor1" class="my-color-field" />
								</div>
								<div class="wprevpre_temp_label_row">
									<input type="number" data-alpha="true" value="<?php echo $float_misc_array['width']; ?>" name="wprevpro_float_misc_width" id="wprevpro_float_misc_width" class="marginpaddinginput" />
								</div>
								<div class="wprevpre_temp_label_row">
									<div class="wprevpre_temp_label_row">
									<?php _e('Top', 'wp-review-slider-pro'); ?>:<input type="number" data-alpha="true" value="<?php echo $float_misc_array['margin-top']; ?>" name="wprevpro_float_misc_margin-top" id="wprevpro_float_misc_margin-top" class="marginpaddinginput" /> 
									<?php _e('Right', 'wp-review-slider-pro'); ?>:<input type="number" data-alpha="true" value="<?php echo $float_misc_array['margin-right']; ?>" name="wprevpro_float_misc_margin-right" id="wprevpro_float_misc_margin-right" class="marginpaddinginput" /> 
									</div>
									<div class="wprevpre_temp_label_row">
									<?php _e('Bottom', 'wp-review-slider-pro'); ?>:<input type="number" data-alpha="true" value="<?php echo $float_misc_array['margin-bottom']; ?>" name="wprevpro_float_misc_margin-bottom" id="wprevpro_float_misc_margin-bottom" class="marginpaddinginput" /> 
									<?php _e('Left', 'wp-review-slider-pro'); ?>:<input type="number" data-alpha="true" value="<?php echo $float_misc_array['margin-left']; ?>" name="wprevpro_float_misc_margin-left" id="wprevpro_float_misc_margin-left" class="marginpaddinginput" />
									</div>
								</div>
								<div class="wprevpre_temp_label_row">
									<div class="wprevpre_temp_label_row">
									<?php _e('Top', 'wp-review-slider-pro'); ?>:<input type="number" data-alpha="true" value="<?php echo $float_misc_array['padding-top']; ?>" name="wprevpro_float_misc_padding-top" id="wprevpro_float_misc_padding-top" class="marginpaddinginput" /> 
									<?php _e('Right', 'wp-review-slider-pro'); ?>:<input type="number" data-alpha="true" value="<?php echo $float_misc_array['padding-right']; ?>" name="wprevpro_float_misc_padding-right" id="wprevpro_float_misc_padding-right" class="marginpaddinginput" />
									</div>
									<div class="wprevpre_temp_label_row">
									<?php _e('Bottom', 'wp-review-slider-pro'); ?>:<input type="number" data-alpha="true" value="<?php echo $float_misc_array['padding-bottom']; ?>" name="wprevpro_float_misc_padding-bottom" id="wprevpro_float_misc_padding-bottom" class="marginpaddinginput" /> 
									<?php _e('Left', 'wp-review-slider-pro'); ?>:<input type="number" data-alpha="true" value="<?php echo $float_misc_array['padding-left']; ?>" name="wprevpro_float_misc_padding-left" id="wprevpro_float_misc_padding-left" class="marginpaddinginput" />
									</div>
								</div>
							</div>
						  </div>
			...
			<tr class="wprevpro_row">
				<th scope="row">
					<?php _e('Float Animation:', 'wp-review-slider-pro'); ?>
				</th>
				<td>
			...
			<tr class="wprevpro_row slidouttr" <?php if($float_misc_array['onclickaction']=='url'){echo "style='display:none;'";} ?>>
				<th scope="row">
