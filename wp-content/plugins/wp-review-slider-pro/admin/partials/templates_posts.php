 ...
 */
	...
	$currenttemplate->display_order_second ="";
	...
	if (isset($_POST['wprevpro_submittemplatebtn'])){
		...
		$templatemiscarray['postfilterlist'] = $this->wprev_commastrtojson($templatemiscarray['postfilterlist']);	
		$templatemiscarray['categoryfilterlist'] = $this->wprev_commastrtojson($templatemiscarray['categoryfilterlist']);	
		$templatemiscarray['langfilterlist'] = $this->wprev_commastrtojson($templatemiscarray['langfilterlist'],'',false);
...
echo $dbmsg;
		...
		<table class="wp-list-table widefat striped posts">
			<thead>
				<tr>
					...
					<th scope="col" width="100px" class="manage-column">'.__('Slider', 'wp-review-slider-pro').'</th>
	...
	$urltrimmed = remove_query_arg( array('taction', 'id') );
		...
		$html .= '<tr id="'.$currentform->id.'">
				...
				<th scope="col" class=" manage-column"><b>'.$currentform->createslider.'</b></th>
		...
		<tbody>
			...
			<tr class="wprevpro_row">
				...
				<td><div id="divtemplatestyles">
					...
					<label for="wprevpro_template_type1-radio"><?php _e('Post or Page', 'wp-review-slider-pro'); ?></label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
			...
			<tr class="wprevpro_row">
				...
				?>
								...
								<div class="wprevpre_temp_label_row">
									<input type="text" data-alpha="true" value="<?php echo $template_misc_array['starcolor']; ?>" name="wprevpro_template_misc_starcolor" id="wprevpro_template_misc_starcolor" class="my-color-field" />
								</div>
...
<h2 class="nav-tab-wrapper">
	...
	<span id="settingtab2" class="settingtab nav-tab cursorpointer gotopage2" >Pagination Settings</span>
		...
		<tr class="wprevpro_row nopaddingtd">
			...
			<tr class="wprevpro_row">
				...
				<td><div class="divtemplatestyles">
					...
					<p class="description">
					<?php _e('How many reviews to display on the page at a time. Widget style templates can only display 1 per row.', 'wp-review-slider-pro'); ?></p>
				</td>
			</tr>
			...
			<tr class="wprevpro_row">
				<th scope="row">
					<?php _e('Create Slider:', 'wp-review-slider-pro'); ?>
				</th>
				<td>
					<div class="divtemplatestyles">
						...
						&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
						<label for="wprevpro_t_display_num_rows"><?php _e('How many total slides?', 'wp-review-slider-pro'); ?></label>
						<select name="wprevpro_t_numslides" id="wprevpro_t_numslides">
					...
					<p class="description">
					<?php _e('Allows you to create a slide show with your reviews.', 'wp-review-slider-pro'); ?></p>
				</td>
			</tr>
			...
			<tr class="wprevpro_row"  id="slidersettingsrow" <?php if($currenttemplate->createslider=="no"){echo "style='display:none;'";} ?>>
				...
				<td>
					<div class="w3_wprs-row slidersettingsdivs">
						...
						<div class="w3_wprs-col s8 slidersettingsdiv">
							<input type="text" name="wprevpro_t_sliderspeed" id="wprevpro_t_sliderspeed" style="width: 3em" value="<?php if($currenttemplate->sliderspeed>0){echo $currenttemplate->sliderspeed;} else { echo '750';} ?>">
						...
						<div class="w3_wprs-col s12 onepermobilerow">
...
<tr class="wprevpro_row nopaddingtd">
			...
			<tr class="wprevpro_row">
				...
				<input id="wprevpro_t_header_text" type="text" name="wprevpro_t_header_text" value="<?php echo $template_misc_array['header_text'];?>" placeholder="<?php echo sprintf(__('Rated %1$s out of 5 stars based on %2$s reviews.', 'wp-review-slider-pro'),'{avgrating}','{totalratings}'); ?>" style="padding-top: 0px;width: 25em;height: 28px;">
...
?>
					...
					<?php _e('"This Template Values" selection allows you to use total and average from a badge or this template.', 'wp-review-slider-pro'); ?><br><?php _e('Allowed html tags:', 'wp-review-slider-pro'); ?> &lt;i&gt;&lt;/i&gt;&lt;em&gt;&lt;/em&gt;&lt;strong&gt;&lt;/strong&gt;&lt;b&gt;&lt;/b&gt;<br>
			...
			<tr class="wprevpro_row">
				...
				<td><div class="">
					...
					<p class="description">
					<?php _e('Non-slider: Adds a button or pagination bar below the reviews that will load more when clicked.<br>Slider: More reviews are loaded automatically when the last slide appears.<br><b>Warning:</b> Only use this if you actually have more reviews that will show up with this template.', 'wp-review-slider-pro'); ?></p>
				</td>
			</tr>
			<tr class="wprevpro_row">
				<th scope="row" colspan="2">
		...
		<tr class="wprevpro_row" style="background: #f4f4f4;">
			...
			<tr class="wprevpro_row fbhide revselectedhide"<?php echo $ctselhidemestyle; ?>>
				...
				<td><a id="wprevpro_btn_pickpages" class="button dashicons-before dashicons-yes"><?php _e('Select Locations', 'wp-review-slider-pro'); ?></a>
					...
					<p class="description">
					<?php _e('Only show reviews from these Locations. Leave blank to show all reviews in your database. Normally only used for downloaded social reviews.', 'wp-review-slider-pro'); ?></p>
				</td>
			</tr>
			<?php
			}
			...
			<tr class="wprevpro_row revselectedhide"<?php echo $ctselhidemestyle; ?>>
				...
				<td><div class="">
					<input class="wprevpro_nr_categories" id="wprevpro_t_langfilterlist" type="text" name="wprevpro_t_langfilterlist" placeholder="" value="<?php echo $langfilterliststr; ?>" style="width: 10em">
					</div>
					<p class="description">
		...
		<tbody>
			...
			<tr class="wprevpro_row">
				...
				<td><div class="divtemplatestyles">
					...
					<label for="wprevpro_t_read_more_num">&nbsp;&nbsp;# </label>
			...
			<tr class="wprevpro_row fbhide">
				...
				<td><div class="divtemplatestyles">
					...
					<select name="wprevpro_t_facebook_icon_link" id="wprevpro_t_facebook_icon_link">
						<option value="yes" <?php if($currenttemplate->facebook_icon_link=='yes'){echo "selected";} ?>><?php _e('Yes', 'wp-review-slider-pro'); ?></option>
			...
			<tr class="wprevpro_row ">
				...
				<td><div class="divtemplatestyles">
					...
					<select name="wprevpro_t_profile_link" id="wprevpro_t_profile_link">
						...
						<option value="yes" <?php if($currenttemplate->add_profile_link=='yes'){echo "selected";} ?>><?php _e('Yes', 'wp-review-slider-pro'); ?></option>
					</select>
					</div>
					<p class="description">
					<?php _e('When turned on, this allows you to click the reviewer avatar and go to their social profile page.', 'wp-review-slider-pro'); ?></p>
				</td>
			</tr>
...
?>
			<tr>
				<td class="notice updated " colspan="2" style="border-left: 4px solid #d6d6d6;">
					<p><strong><?php _e('Upgrade to the Pro Version of this plugin to access more super cool settings! <a href="'.plugin_dir_url( __FILE__ ) . 'pro_settings.png" target="_blank">(Screenshot)</a> Get the Pro Version <a href="' . wrsp_fs()->get_upgrade_url() . '">here</a>!', 'wp-fb-reviews'); ?></strong></p>
				</td>
			</tr>
<?php
    }
