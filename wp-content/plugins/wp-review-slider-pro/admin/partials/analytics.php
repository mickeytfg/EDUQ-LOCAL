...
<div class="w3-row">
	<div class="w3-col m3 boxouter">
		<select id="location_multiple_select" class="js-example-basic-multiple" name="states[]" multiple="multiple" style="width: 100%">
		<?php
	...
	<div class="w3-col m3 boxouter">
		<select id="type_multiple_select" class="js-example-basic-multiple" name="states[]" multiple="multiple" style="width: 100%">
		<?php
...
<div class="w3-row">
	<div class="w3-col m3 boxouter">
		<div class="boxcontent">
			<div id="avg_rating" class="wppro_smallheader w3-center"><?php _e('Average Rating:', 'wp-review-slider-pro'); ?>  <span id="avg_rating_num"></span> <span class="wprsp-star w3-text-gold"></span></div>
			<div class="w3-row">
				<div class="w3-col s2">
				&nbsp;
				</div>
				<div class="w3-col s4 starrowdivs">
					<div class="starrow wprevpro_star_imgs"><span class="wprsp-star"></span><span class="wprsp-star"></span><span class="wprsp-star"></span><span class="wprsp-star"></span><span class="wprsp-star"></span></div>
					<div class="starrow wprevpro_star_imgs"><span class="wprsp-star"></span><span class="wprsp-star"></span><span class="wprsp-star"></span><span class="wprsp-star"></span></div>
					<div class="starrow wprevpro_star_imgs"><span class="wprsp-star"></span><span class="wprsp-star"></span><span class="wprsp-star"></span></div>
					<div class="starrow wprevpro_star_imgs"><span class="wprsp-star"></span><span class="wprsp-star"></span></div>
					<div class="starrow wprevpro_star_imgs"><span class="wprsp-star"></span></div>
				</div>
					...
					<div class="wpproslider_t6_DIV_3">
						...
						<div class="wpproslider_t6_star_DIV">
							<span id="starloc1" class="wprevpro_star_imgs" style="color: rgb(253, 211, 20);">
								<span class="wprsp-star"></span><span class="wprsp-star"></span><span class="wprsp-star"></span><span class="wprsp-star"></span><span class="wprsp-star-o"></span>
							</span>
						</div>
