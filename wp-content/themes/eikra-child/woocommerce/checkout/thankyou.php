...
<div class="woocommerce-order child-theme">
    ...
    <?php if ($order) : ?>
        ...
        <?php else : ?>
            <p class="woocommerce-notice woocommerce-notice--success woocommerce-thankyou-order-received"><?php echo apply_filters('woocommerce_thankyou_order_received_text', __('Bedankt. Je bestelling is ontvangen.', 'woocommerce'), $order); ?></p>
    ...
    <?php else : ?>
        ...
        <p class="woocommerce-notice woocommerce-notice--success woocommerce-thankyou-order-received"><?php echo apply_filters('woocommerce_thankyou_order_received_text', __('Bedankt. Je bestelling is ontvangen.', 'woocommerce'), null); ?></p>
