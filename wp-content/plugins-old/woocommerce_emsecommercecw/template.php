...
require_once dirname(__FILE__) .'/classes/EMSeCommerceCw/ContextRequest.php';
$httpRequest = EMSeCommerceCw_ContextRequest::getInstance();
...
ob_start();
$vars = array( 
	'title' => __('Payment', 'woocommerce_emsecommercecw'),
	'content' => '$$$PAYMENT ZONE$$$'
);
EMSeCommerceCw_Util::includeTemplateFile('page', $vars);
