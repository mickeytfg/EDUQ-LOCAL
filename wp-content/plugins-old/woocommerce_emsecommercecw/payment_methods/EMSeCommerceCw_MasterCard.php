...
class EMSeCommerceCw_MasterCard extends EMSeCommerceCw_PaymentMethod
{
	...
	public function __construct() {
		$this->icon = apply_filters(
			'woocommerce_emsecommercecw_mastercard_icon', 
			EMSeCommerceCw_Util::getResourcesUrl('icons/mastercard.png')
		);
		parent::__construct();
	}
