...
class EMSeCommerceCw_IDeal extends EMSeCommerceCw_PaymentMethod
{
	...
	public function __construct() {
		$this->icon = apply_filters(
			'woocommerce_emsecommercecw_ideal_icon', 
			EMSeCommerceCw_Util::getResourcesUrl('icons/ideal.png')
		);
		parent::__construct();
	}
