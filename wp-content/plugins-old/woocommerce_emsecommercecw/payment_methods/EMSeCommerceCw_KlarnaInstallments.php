...
class EMSeCommerceCw_KlarnaInstallments extends EMSeCommerceCw_PaymentMethod
{
	public $machineName = 'klarnainstallments';
	public $admin_title = 'Klarna Installments';
	public $title = 'Klarna Installments';
	
	protected function getMethodSettings(){
		return array(
			'klarna_shared_secret' => array(
				'title' => __("Klarna: Shared Secret", 'woocommerce_emsecommercecw'),
 				'default' => '',
 				'description' => __("Please specify the shared secret your Klarna account.", 'woocommerce_emsecommercecw'),
 				'cwType' => 'password',
 				'type' => 'text',
 			),
 			'klarna_merchant_id' => array(
				'title' => __("Klarna: Merchant ID", 'woocommerce_emsecommercecw'),
 				'default' => '',
 				'description' => __("Please specify the merchant id (EID) of your Klarna account.", 'woocommerce_emsecommercecw'),
 				'cwType' => 'textfield',
 				'type' => 'text',
 			),
 			...
 			'status_finallydeclined' => array(
				'title' => __("Declined Status", 'woocommerce_emsecommercecw'),
 				'default' => 'no_status_change',
 				'description' => __("You can specify the order status for orders that are declined after being pending.", 'woocommerce_emsecommercecw'),
 				'cwType' => 'orderstatusselect',
 				'type' => 'select',
 				'options' => array(
					'no_status_change' => __("Don't change order status", 'woocommerce_emsecommercecw'),
 			...
 			'authorizationMethod' => array(
				'title' => __("Authorization Method", 'woocommerce_emsecommercecw'),
 				...
 				'type' => 'select',
 				'options' => array(
					'ServerAuthorization' => __("Server Authorization", 'woocommerce_emsecommercecw'),
 				),
 			),
 		); 
	}
	...
	public function __construct() {
		$this->icon = apply_filters(
			'woocommerce_emsecommercecw_klarnainstallments_icon', 
			EMSeCommerceCw_Util::getResourcesUrl('icons/klarnainstallments.png')
		);
		parent::__construct();
	}
