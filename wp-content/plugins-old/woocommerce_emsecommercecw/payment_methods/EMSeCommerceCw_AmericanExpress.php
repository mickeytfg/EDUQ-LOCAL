...
class EMSeCommerceCw_AmericanExpress extends EMSeCommerceCw_PaymentMethod
{
	...
	public function __construct() {
		$this->icon = apply_filters(
			'woocommerce_emsecommercecw_americanexpress_icon', 
			EMSeCommerceCw_Util::getResourcesUrl('icons/americanexpress.png')
		);
		parent::__construct();
	}
