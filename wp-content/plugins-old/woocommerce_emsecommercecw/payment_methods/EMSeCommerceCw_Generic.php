...
class EMSeCommerceCw_Generic extends EMSeCommerceCw_PaymentMethod
{
	public $machineName = 'generic';
	public $admin_title = 'Generic';
	public $title = 'Generic';
	...
	public function __construct() {
		$this->icon = apply_filters(
			'woocommerce_emsecommercecw_generic_icon', 
			EMSeCommerceCw_Util::getResourcesUrl('icons/generic.png')
		);
		parent::__construct();
	}
