...
class EMSeCommerceCw_ClickandBuy extends EMSeCommerceCw_PaymentMethod
{
	public $machineName = 'clickandbuy';
	public $admin_title = 'ClickandBuy';
	public $title = 'ClickandBuy';
	...
	public function __construct() {
		$this->icon = apply_filters(
			'woocommerce_emsecommercecw_clickandbuy_icon', 
			EMSeCommerceCw_Util::getResourcesUrl('icons/clickandbuy.png')
		);
		parent::__construct();
	}
