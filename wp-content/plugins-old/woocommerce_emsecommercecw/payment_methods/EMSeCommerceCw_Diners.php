...
class EMSeCommerceCw_Diners extends EMSeCommerceCw_PaymentMethod
{
	...
	public function __construct() {
		$this->icon = apply_filters(
			'woocommerce_emsecommercecw_diners_icon', 
			EMSeCommerceCw_Util::getResourcesUrl('icons/diners.png')
		);
		parent::__construct();
	}
