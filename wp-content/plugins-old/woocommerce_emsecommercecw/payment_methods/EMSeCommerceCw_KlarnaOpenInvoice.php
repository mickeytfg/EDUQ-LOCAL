...
class EMSeCommerceCw_KlarnaOpenInvoice extends EMSeCommerceCw_PaymentMethod
{
	public $machineName = 'klarnaopeninvoice';
	public $admin_title = 'Klarna Open Invoice';
	public $title = 'Klarna Open Invoice';
	...
	public function __construct() {
		$this->icon = apply_filters(
			'woocommerce_emsecommercecw_klarnaopeninvoice_icon', 
			EMSeCommerceCw_Util::getResourcesUrl('icons/klarnaopeninvoice.png')
		);
		parent::__construct();
	}
