...
class EMSeCommerceCw_PayPal extends EMSeCommerceCw_PaymentMethod
{
	...
	public function __construct() {
		$this->icon = apply_filters(
			'woocommerce_emsecommercecw_paypal_icon', 
			EMSeCommerceCw_Util::getResourcesUrl('icons/paypal.png')
		);
		parent::__construct();
	}
