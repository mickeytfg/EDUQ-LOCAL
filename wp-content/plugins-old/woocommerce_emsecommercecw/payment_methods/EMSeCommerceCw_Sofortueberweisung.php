...
class EMSeCommerceCw_Sofortueberweisung extends EMSeCommerceCw_PaymentMethod
{
	...
	public function __construct() {
		$this->icon = apply_filters(
			'woocommerce_emsecommercecw_sofortueberweisung_icon', 
			EMSeCommerceCw_Util::getResourcesUrl('icons/sofortueberweisung.png')
		);
		parent::__construct();
	}
