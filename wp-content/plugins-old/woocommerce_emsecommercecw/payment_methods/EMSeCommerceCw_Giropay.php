...
class EMSeCommerceCw_Giropay extends EMSeCommerceCw_PaymentMethod
{
	...
	public function __construct() {
		$this->icon = apply_filters(
			'woocommerce_emsecommercecw_giropay_icon', 
			EMSeCommerceCw_Util::getResourcesUrl('icons/giropay.png')
		);
		parent::__construct();
	}
