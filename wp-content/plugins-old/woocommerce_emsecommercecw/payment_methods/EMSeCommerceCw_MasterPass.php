...
class EMSeCommerceCw_MasterPass extends EMSeCommerceCw_PaymentMethod
{
	...
	public function __construct() {
		$this->icon = apply_filters(
			'woocommerce_emsecommercecw_masterpass_icon', 
			EMSeCommerceCw_Util::getResourcesUrl('icons/masterpass.png')
		);
		parent::__construct();
	}
