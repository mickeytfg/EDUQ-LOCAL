...
class EMSeCommerceCw_DirectDebitsSepa extends EMSeCommerceCw_PaymentMethod
{
	...
	public function __construct() {
		$this->icon = apply_filters(
			'woocommerce_emsecommercecw_directdebitssepa_icon', 
			EMSeCommerceCw_Util::getResourcesUrl('icons/directdebitssepa.png')
		);
		parent::__construct();
	}
