...
<?php if ( ! empty( $availableMethods ) ) : ?>
	<thead>
		<th></th>
		<th><?php echo __("Shipping Method" ,"woocommerce_emsecommercecw");?></th>
		<th><?php echo __("Costs", "woocommerce_emsecommercecw");?></th>
	</thead>
	<tbody>
	<?php if ( count( $availableMethods ) > 0) :
			foreach ( $availableMethods as $method ) : ?>
				...
				<td>
					<?php echo woocommerce_emsecommercecw_format_shipping_amount_like_shop($method);?>
				</td>
				</tr>
