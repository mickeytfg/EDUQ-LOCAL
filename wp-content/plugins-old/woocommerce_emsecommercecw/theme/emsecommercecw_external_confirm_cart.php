...
<table class="emsecommercecw-external-checkout-line-items-table">

	<thead>
		<tr>
			<th class="head-name"><?php echo __("Product", "woocommerce_emsecommercecw"); ?></th>
			<td class="head-quantity"><?php echo __("Quantity", "woocommerce_emsecommercecw"); ?></td>
			<td class="head-total"><?php echo __("Subtotal", "woocommerce_emsecommercecw"); ?></td>
		</tr>
	</thead>
	<tbody>
	...
	<tfoot>
		...
		<tr class="cart-subtotal">
			<th colspan="2"><?php echo __( 'Cart Subtotal', 'woocommerce_emsecommercecw' ); ?></th>
		...
		<?php if(isset($shipping)): ?>
			<tr class="shipping">
				<th colspan="2"><?php echo __( 'Shipping &amp; Handling', 'woocommerce_emsecommercecw' ); ?></th>
		...
		<tr class="order-total">
			<th colspan="2"><?php echo __( 'Order Total', 'woocommerce_emsecommercecw' ); ?></th>
