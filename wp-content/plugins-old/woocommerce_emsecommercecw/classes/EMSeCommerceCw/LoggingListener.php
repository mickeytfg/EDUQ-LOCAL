 ...
 */
class EMSeCommerceCw_LoggingListener implements Customweb_Core_Logger_IListener {
	...
	public function addLogEntry($loggerName, $level, $message, Exception $e = null, $object = null){
		...
		self::$logger->add('EMSeCommerceCw', $content);
	}

	private function isLevelActive($level){
		switch (EMSeCommerceCw_ConfigurationAdapter::getLoggingLevel()) {
			case 'debug':
				return true;
			case 'info':
