 ...
 *
 */
require_once 'EMSeCommerceCw/AbstractConfigurationAdapter.php';


/**
 * @Bean
 */
class EMSeCommerceCw_ConfigurationAdapter extends EMSeCommerceCw_AbstractConfigurationAdapter {

	public static function isReviewFormInputActive(){
		$value = get_option('woocommerce_emsecommercecw_review_input_form', 'active');
		if ($value == 'active') {
			return true;
		}
		else {
	...
	public static function getExternalCheckoutPlacement(){
		return get_option('woocommerce_emsecommercecw_external_checkout_placement', 'both');
	}
	
	public static function getExternalCheckoutAccountCreation(){
		return get_option('woocommerce_emsecommercecw_external_checkout_account_creation', 'skip_selection');
	}
	
	public static function getOrderNumberIdentifier(){
		return get_option('woocommerce_emsecommercecw_order_identifier', 'ordernumber');
	}
	
	public static function getLoggingLevel(){
		return get_option('woocommerce_emsecommercecw_log_level', 'error');
	}
