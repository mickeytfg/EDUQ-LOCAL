 ...
 *
 */
class EMSeCommerceCw_Dispatcher
{
	...
	public function dispatch() {
		try {
			$request = EMSeCommerceCw_ContextRequest::getInstance();
	...
	private function getControllerInstance() {
		...
		$expectedClassName = 'EMSeCommerceCw_Controller_' . Customweb_Core_Util_String::ucFirst($this->controllerName);
		$effectiveClass = null;
