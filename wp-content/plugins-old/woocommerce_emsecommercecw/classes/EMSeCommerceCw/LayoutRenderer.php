...
class EMSeCommerceCw_LayoutRenderer implements Customweb_Mvc_Layout_IRenderer{
	...
	public function render(Customweb_Mvc_Layout_IRenderContext $context) {
		...
		if(!empty($title)) {
			$GLOBALS['woo_emsecommercecwTitle'] = $title;
		}
		...
		$GLOBALS['woo_emsecommercecwCSS'] = $cssString;
		...
		$GLOBALS['woo_emsecommercecwJS'] = $jsString;
		$GLOBALS['woo_emsecommercecwContent'] = $context->getMainContent();
