 ...
 *
 */
abstract class EMSeCommerceCw_AbstractCartOrderContext extends Customweb_Payment_Authorization_OrderContext_AbstractDeprecated {
	protected $cart;
	...
	public function getBillingState(){
		if (isset($this->userData['billing_state'])) {
			return EMSeCommerceCw_Util::cleanUpStateField($this->userData['billing_state'], $this->getBillingCountryIsoCode());
		}
		else {
			return null;
		}
	...
	public function getShippingState(){
		if ($this->isShipToBilling() || !isset($this->userData['shipping_state'])) {
			...
			return EMSeCommerceCw_Util::cleanUpStateField($this->userData['shipping_state'], $this->getShippingCountryIsoCode());
		}
	}
