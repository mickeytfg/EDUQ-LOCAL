...
class EMSeCommerceCw_PaymentMethodWrapper implements Customweb_Payment_Authorization_IPaymentMethod {
	...
	/**
	 * @var EMSeCommerceCw_PaymentMethod
	 */
	private $method = null;
	
	public function __construct(EMSeCommerceCw_PaymentMethod $method) {
	...
	protected function getMethod() {
		if ($this->method === null) {
			...
			EMSeCommerceCw_Util::includePaymentMethod($paymentMethod);
