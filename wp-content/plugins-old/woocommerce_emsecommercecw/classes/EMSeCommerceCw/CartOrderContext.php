 ...
 *
 */
require_once 'EMSeCommerceCw/AbstractCartOrderContext.php';
 ...
 *
 */
class EMSeCommerceCw_CartOrderContext extends EMSeCommerceCw_AbstractCartOrderContext {
	...
	public function getInvoiceItems(){
		return EMSeCommerceCw_CartUtil::getInoviceItemsFromCart($this->cart);
	}
