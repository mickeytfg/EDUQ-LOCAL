...
class EMSeCommerceCw_Migration_1_0_0 implements Customweb_Database_Migration_IScript {

	public function execute(Customweb_Database_IDriver $driver){
		global $wpdb;
		$driver->query(
				"CREATE TABLE IF NOT EXISTS `" . $wpdb->prefix . "emsecommercecw_transactions` (
