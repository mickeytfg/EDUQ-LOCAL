 ...
 *
 */
class Customweb_EMSeCommerce_Container extends Customweb_Payment_AbstractContainer {
	...
	public function getConfiguration(){
		return $this->getBean('Customweb_EMSeCommerce_Configuration');
	}
	...
	public function getMethodFactory(){
		return $this->getBean('Customweb_EMSeCommerce_Method_Factory');
	}
	 ...
	 * @return Customweb_EMSeCommerce_Method_DefaultMethod
	 */
	 ...
	 * @return Customweb_EMSeCommerce_Method_DefaultMethod
	 */
	public function getPaymentMethodByTransaction(Customweb_EMSeCommerce_Authorization_Transaction $transaction){
