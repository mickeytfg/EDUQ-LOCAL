...
class Customweb_EMSeCommerce_Authorization_Transaction extends Customweb_Payment_Authorization_DefaultTransaction
{
	...
	protected function getState3DSecureLabel(){
		$labels = array();
		if($this->getThreeDSecureState() == Customweb_EMSeCommerce_IConstants::THREE_D_FAILED) {
			$labels['3DSecure'] = array(
					'label' => Customweb_I18n_Translation::__('3D Secure'),
					'value' => Customweb_I18n_Translation::__('Failed')
			);
		}
		elseif($this->getThreeDSecureState() == Customweb_EMSeCommerce_IConstants::THREE_D_SUCCESS) {
			$labels['3DSecure'] = array(
					'label' => Customweb_I18n_Translation::__('3D Secure'),
					'value' => Customweb_I18n_Translation::__('Successful')
			);
		}
			elseif($this->getThreeDSecureState() == Customweb_EMSeCommerce_IConstants::THREE_D_NOT_ENROLLED) {
			$labels['3DSecure'] = array(
					'label' => Customweb_I18n_Translation::__('3D Secure'),
					'value' => Customweb_I18n_Translation::__('Not enrolled')
			);
		}
		elseif($this->getThreeDSecureState() == Customweb_EMSeCommerce_IConstants::THREE_D_AUTH_ATTEMPTED) {
			$labels['3DSecure'] = array(
					'label' => Customweb_I18n_Translation::__('3D Secure'),
					'value' => Customweb_I18n_Translation::__('Authorization Attempted')
			);
		}
		elseif($this->getThreeDSecureState() == Customweb_EMSeCommerce_IConstants::THREE_D_AUTH_SERVER) {
			$labels['3DSecure'] = array(
					'label' => Customweb_I18n_Translation::__('3D Secure'),
					'value' => Customweb_I18n_Translation::__('Authentication Server Error')
			);
		}
		elseif($this->getThreeDSecureState() == Customweb_EMSeCommerce_IConstants::THREE_D_DIR_SERVER) {
			$labels['3DSecure'] = array(
					'label' => Customweb_I18n_Translation::__('3D Secure'),
