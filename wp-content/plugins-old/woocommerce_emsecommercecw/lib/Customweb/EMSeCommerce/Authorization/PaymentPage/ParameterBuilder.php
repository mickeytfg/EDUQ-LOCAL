...
class Customweb_EMSeCommerce_Authorization_PaymentPage_ParameterBuilder extends Customweb_EMSeCommerce_Authorization_AbstractParameterBuilder {
	...
	public function buildParameters(){
		...
		$parameters['hashExtended'] = Customweb_EMSeCommerce_Util::calculateExtendedHash($parameters,
