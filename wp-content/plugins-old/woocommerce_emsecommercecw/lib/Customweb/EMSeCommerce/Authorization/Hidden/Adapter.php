...
require_once 'Customweb/EMSeCommerce/Authorization/Hidden/ParameterBuilder.php';
...
class Customweb_EMSeCommerce_Authorization_Hidden_Adapter extends Customweb_EMSeCommerce_Authorization_AbstractAdapter 
	...
	public function getHiddenFormFields(Customweb_Payment_Authorization_ITransaction $transaction) {
		$builder = new Customweb_EMSeCommerce_Authorization_Hidden_ParameterBuilder($transaction, $this->getContainer(), array());
	...
	public function getFormActionUrl(Customweb_Payment_Authorization_ITransaction $transaction) {
		return $this->getConfiguration()->getBaseUrl().Customweb_EMSeCommerce_IConstants::URL_CONNECT;
