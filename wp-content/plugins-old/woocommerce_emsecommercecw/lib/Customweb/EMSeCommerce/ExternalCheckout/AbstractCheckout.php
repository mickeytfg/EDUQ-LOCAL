 ...
 *
 */
abstract class Customweb_EMSeCommerce_ExternalCheckout_AbstractCheckout extends Customweb_Payment_ExternalCheckout_AbstractCheckout{

	private $container;
	
	public function __construct(Customweb_DependencyInjection_IContainer $container) {
		parent::__construct(new Customweb_EMSeCommerce_Container($container));
	}
