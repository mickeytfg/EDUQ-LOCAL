...
class Customweb_EMSeCommerce_ExternalCheckout_MasterPass_ConfirmationParameterBuilder extends Customweb_EMSeCommerce_AbstractParameterBuilder {
	
	private $transaction;
	
	private $providerData;

	public function __construct(Customweb_DependencyInjection_IContainer $container, Customweb_EMSeCommerce_Authorization_Transaction $transaction, array $providerData){
	...
	protected function getPaymentParameters(){
		...
		$parameters['currency'] = Customweb_EMSeCommerce_Util::getNumericCurrencyCode($this->getTransaction()->getCurrencyCode());
		return $parameters;
	}
}