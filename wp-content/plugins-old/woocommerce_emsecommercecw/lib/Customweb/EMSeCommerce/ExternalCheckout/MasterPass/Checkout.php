 ...
 *
 */
class Customweb_EMSeCommerce_ExternalCheckout_MasterPass_Checkout extends Customweb_EMSeCommerce_ExternalCheckout_AbstractCheckout {
	...
	public function getMachineName(){
		return 'emsecommerce_masterpass';
	}
