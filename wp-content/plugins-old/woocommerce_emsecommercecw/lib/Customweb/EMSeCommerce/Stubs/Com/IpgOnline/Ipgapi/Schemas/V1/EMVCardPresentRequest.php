 ...
 */ 
class Customweb_EMSeCommerce_Stubs_Com_IpgOnline_Ipgapi_Schemas_V1_EMVCardPresentRequest {
	/**
	...
	/**
	 * @XmlElement(name="EMVRequestData", type="Customweb_EMSeCommerce_Stubs_Com_IpgOnline_Ipgapi_Schemas_V1_EMVRequestData", namespace="http://ipg-online.com/ipgapi/schemas/v1")
	 * @var Customweb_EMSeCommerce_Stubs_Com_IpgOnline_Ipgapi_Schemas_V1_EMVRequestData
	 */
	private $eMVRequestData;
	
	/**
	 * @XmlElement(name="TLVData", type="Customweb_EMSeCommerce_Stubs_Com_IpgOnline_Ipgapi_Schemas_V1_TLVData", namespace="http://ipg-online.com/ipgapi/schemas/v1")
	 * @var Customweb_EMSeCommerce_Stubs_Com_IpgOnline_Ipgapi_Schemas_V1_TLVData
	 */
	private $tLVData;
	...
	public static function _() {
		$i = new Customweb_EMSeCommerce_Stubs_Com_IpgOnline_Ipgapi_Schemas_V1_EMVCardPresentRequest();
		return $i;
	}
	/**
	 ...
	 * 
	 * @param Customweb_EMSeCommerce_Stubs_Com_IpgOnline_Ipgapi_Schemas_V1_EMVRequestData $eMVRequestData
	 * @return Customweb_EMSeCommerce_Stubs_Com_IpgOnline_Ipgapi_Schemas_V1_EMVCardPresentRequest
	 */
	public function setEMVRequestData($eMVRequestData){
		if ($eMVRequestData instanceof Customweb_EMSeCommerce_Stubs_Com_IpgOnline_Ipgapi_Schemas_V1_EMVRequestData) {
			$this->eMVRequestData = $eMVRequestData;
		}
		else {
			throw new BadMethodCallException("Type of argument eMVRequestData must be Customweb_EMSeCommerce_Stubs_Com_IpgOnline_Ipgapi_Schemas_V1_EMVRequestData.");
		}
		return $this;
	}
	 ...
	 * 
	 * @return Customweb_EMSeCommerce_Stubs_Com_IpgOnline_Ipgapi_Schemas_V1_TLVData
	 */
	 ...
	 * 
	 * @param Customweb_EMSeCommerce_Stubs_Com_IpgOnline_Ipgapi_Schemas_V1_TLVData $tLVData
	 * @return Customweb_EMSeCommerce_Stubs_Com_IpgOnline_Ipgapi_Schemas_V1_EMVCardPresentRequest
	 */
	public function setTLVData($tLVData){
		if ($tLVData instanceof Customweb_EMSeCommerce_Stubs_Com_IpgOnline_Ipgapi_Schemas_V1_TLVData) {
			$this->tLVData = $tLVData;
		}
		else {
			throw new BadMethodCallException("Type of argument tLVData must be Customweb_EMSeCommerce_Stubs_Com_IpgOnline_Ipgapi_Schemas_V1_TLVData.");
		}
		return $this;
	}
