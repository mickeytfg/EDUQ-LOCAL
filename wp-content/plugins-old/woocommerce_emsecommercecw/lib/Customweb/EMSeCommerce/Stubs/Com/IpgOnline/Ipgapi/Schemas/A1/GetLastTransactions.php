 ...
 */ 
class Customweb_EMSeCommerce_Stubs_Com_IpgOnline_Ipgapi_Schemas_A1_GetLastTransactions {
	/**
	...
	/**
	 * @XmlElement(name="count", type="Customweb_EMSeCommerce_Stubs_Com_IpgOnline_Ipgapi_Schemas_A1_GetLastTransactions_Count", namespace="http://ipg-online.com/ipgapi/schemas/a1")
	 * @var Customweb_EMSeCommerce_Stubs_Com_IpgOnline_Ipgapi_Schemas_A1_GetLastTransactions_Count
	 */
	private $count = '10';
	...
	/**
	 * @XmlElement(name="TDate", type="Customweb_EMSeCommerce_Stubs_Com_IpgOnline_Ipgapi_Schemas_A1_GetLastTransactions_TDate", namespace="http://ipg-online.com/ipgapi/schemas/a1")
	 * @var Customweb_EMSeCommerce_Stubs_Com_IpgOnline_Ipgapi_Schemas_A1_GetLastTransactions_TDate
	 */
	private $tDate;
	...
	public static function _() {
		$i = new Customweb_EMSeCommerce_Stubs_Com_IpgOnline_Ipgapi_Schemas_A1_GetLastTransactions();
		return $i;
	}
	/**
	 ...
	 * 
	 * @return Customweb_EMSeCommerce_Stubs_Com_IpgOnline_Ipgapi_Schemas_A1_GetLastTransactions_Count
	 */
	 ...
	 * 
	 * @param Customweb_EMSeCommerce_Stubs_Com_IpgOnline_Ipgapi_Schemas_A1_GetLastTransactions_Count $count
	 * @return Customweb_EMSeCommerce_Stubs_Com_IpgOnline_Ipgapi_Schemas_A1_GetLastTransactions
	 */
	public function setCount($count){
		if ($count instanceof Customweb_EMSeCommerce_Stubs_Com_IpgOnline_Ipgapi_Schemas_A1_GetLastTransactions_Count) {
			$this->count = $count;
		}
		else {
			throw new BadMethodCallException("Type of argument count must be Customweb_EMSeCommerce_Stubs_Com_IpgOnline_Ipgapi_Schemas_A1_GetLastTransactions_Count.");
		}
		return $this;
	}
	 ...
	 * 
	 * @return Customweb_EMSeCommerce_Stubs_Com_IpgOnline_Ipgapi_Schemas_A1_GetLastTransactions_TDate
	 */
	 ...
	 * 
	 * @param Customweb_EMSeCommerce_Stubs_Com_IpgOnline_Ipgapi_Schemas_A1_GetLastTransactions_TDate $tDate
	 * @return Customweb_EMSeCommerce_Stubs_Com_IpgOnline_Ipgapi_Schemas_A1_GetLastTransactions
	 */
	public function setTDate($tDate){
		if ($tDate instanceof Customweb_EMSeCommerce_Stubs_Com_IpgOnline_Ipgapi_Schemas_A1_GetLastTransactions_TDate) {
			$this->tDate = $tDate;
		}
		else {
			throw new BadMethodCallException("Type of argument tDate must be Customweb_EMSeCommerce_Stubs_Com_IpgOnline_Ipgapi_Schemas_A1_GetLastTransactions_TDate.");
		}
		return $this;
	}
