 ...
 */ 
class Customweb_EMSeCommerce_Stubs_Com_IpgOnline_Ipgapi_Schemas_A1_StoreHostedData {
	/**
	...
	/**
	 * @XmlList(name="DataStorageItem", type='Customweb_EMSeCommerce_Stubs_Com_IpgOnline_Ipgapi_Schemas_A1_DataStorageItem', namespace="http://ipg-online.com/ipgapi/schemas/a1")
	...
	public static function _() {
		$i = new Customweb_EMSeCommerce_Stubs_Com_IpgOnline_Ipgapi_Schemas_A1_StoreHostedData();
		return $i;
	}
	/**
