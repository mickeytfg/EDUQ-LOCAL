 ...
 */ 
class Customweb_EMSeCommerce_Stubs_Com_IpgOnline_Ipgapi_Schemas_A1_SendEMailNotification {
	/**
	...
	/**
	 * @XmlElement(name="TDate", type="Customweb_EMSeCommerce_Stubs_Com_IpgOnline_Ipgapi_Schemas_A1_SendEMailNotification_TDate", namespace="http://ipg-online.com/ipgapi/schemas/a1")
	 * @var Customweb_EMSeCommerce_Stubs_Com_IpgOnline_Ipgapi_Schemas_A1_SendEMailNotification_TDate
	 */
	private $tDate;
	
	/**
	 * @XmlElement(name="Email", type="Customweb_EMSeCommerce_Stubs_Com_IpgOnline_Ipgapi_Schemas_V1_String64max", namespace="http://ipg-online.com/ipgapi/schemas/a1")
	...
	public static function _() {
		$i = new Customweb_EMSeCommerce_Stubs_Com_IpgOnline_Ipgapi_Schemas_A1_SendEMailNotification();
		return $i;
	}
	/**
	 ...
	 * 
	 * @return Customweb_EMSeCommerce_Stubs_Com_IpgOnline_Ipgapi_Schemas_A1_SendEMailNotification_TDate
	 */
	 ...
	 * 
	 * @param Customweb_EMSeCommerce_Stubs_Com_IpgOnline_Ipgapi_Schemas_A1_SendEMailNotification_TDate $tDate
	 * @return Customweb_EMSeCommerce_Stubs_Com_IpgOnline_Ipgapi_Schemas_A1_SendEMailNotification
	 */
	public function setTDate($tDate){
		if ($tDate instanceof Customweb_EMSeCommerce_Stubs_Com_IpgOnline_Ipgapi_Schemas_A1_SendEMailNotification_TDate) {
			$this->tDate = $tDate;
		}
		else {
			throw new BadMethodCallException("Type of argument tDate must be Customweb_EMSeCommerce_Stubs_Com_IpgOnline_Ipgapi_Schemas_A1_SendEMailNotification_TDate.");
		}
		return $this;
	}
