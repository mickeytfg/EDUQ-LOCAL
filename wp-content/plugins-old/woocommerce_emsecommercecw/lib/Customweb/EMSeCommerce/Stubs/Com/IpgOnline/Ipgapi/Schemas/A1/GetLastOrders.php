 ...
 */ 
class Customweb_EMSeCommerce_Stubs_Com_IpgOnline_Ipgapi_Schemas_A1_GetLastOrders {
	/**
	...
	/**
	 * @XmlElement(name="Count", type="Customweb_EMSeCommerce_Stubs_Com_IpgOnline_Ipgapi_Schemas_A1_GetLastOrders_Count", namespace="http://ipg-online.com/ipgapi/schemas/a1")
	 * @var Customweb_EMSeCommerce_Stubs_Com_IpgOnline_Ipgapi_Schemas_A1_GetLastOrders_Count
	 */
	private $count = '10';
	
	/**
	 * @XmlValue(name="DateFrom", simpleType=@XmlSimpleTypeDefinition(typeName='dateTime', typeNamespace='http://www.w3.org/2001/XMLSchema', type='Customweb_EMSeCommerce_Stubs_Org_W3_XMLSchema_DateTime'), namespace="http://ipg-online.com/ipgapi/schemas/a1")
	 * @var Customweb_Xml_Binding_DateHandler_DateTime
	 */
	private $dateFrom;
	
	/**
	 * @XmlValue(name="DateTo", simpleType=@XmlSimpleTypeDefinition(typeName='dateTime', typeNamespace='http://www.w3.org/2001/XMLSchema', type='Customweb_EMSeCommerce_Stubs_Org_W3_XMLSchema_DateTime'), namespace="http://ipg-online.com/ipgapi/schemas/a1")
	 * @var Customweb_Xml_Binding_DateHandler_DateTime
	 */
	private $dateTo;
	...
	public static function _() {
		$i = new Customweb_EMSeCommerce_Stubs_Com_IpgOnline_Ipgapi_Schemas_A1_GetLastOrders();
		return $i;
	}
	/**
	 ...
	 * 
	 * @return Customweb_EMSeCommerce_Stubs_Com_IpgOnline_Ipgapi_Schemas_A1_GetLastOrders_Count
	 */
	 ...
	 * 
	 * @param Customweb_EMSeCommerce_Stubs_Com_IpgOnline_Ipgapi_Schemas_A1_GetLastOrders_Count $count
	 * @return Customweb_EMSeCommerce_Stubs_Com_IpgOnline_Ipgapi_Schemas_A1_GetLastOrders
	 */
	public function setCount($count){
		if ($count instanceof Customweb_EMSeCommerce_Stubs_Com_IpgOnline_Ipgapi_Schemas_A1_GetLastOrders_Count) {
			$this->count = $count;
		}
		else {
			throw new BadMethodCallException("Type of argument count must be Customweb_EMSeCommerce_Stubs_Com_IpgOnline_Ipgapi_Schemas_A1_GetLastOrders_Count.");
		}
		return $this;
	}
	...
	public function setDateFrom($dateFrom){
		if ($dateFrom instanceof Customweb_EMSeCommerce_Stubs_Org_W3_XMLSchema_DateTime) {
			$this->dateFrom = $dateFrom;
		}
		else {
			$this->dateFrom = Customweb_EMSeCommerce_Stubs_Org_W3_XMLSchema_DateTime::_()->set($dateFrom);
		}
		return $this;
	}
	...
	public function setDateTo($dateTo){
		if ($dateTo instanceof Customweb_EMSeCommerce_Stubs_Org_W3_XMLSchema_DateTime) {
			$this->dateTo = $dateTo;
		}
		else {
			$this->dateTo = Customweb_EMSeCommerce_Stubs_Org_W3_XMLSchema_DateTime::_()->set($dateTo);
		}
		return $this;
	}
