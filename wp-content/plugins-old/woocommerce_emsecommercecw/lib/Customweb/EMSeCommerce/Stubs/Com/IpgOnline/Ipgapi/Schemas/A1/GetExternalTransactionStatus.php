 ...
 */ 
class Customweb_EMSeCommerce_Stubs_Com_IpgOnline_Ipgapi_Schemas_A1_GetExternalTransactionStatus {
	/**
	...
	/**
	 * @XmlElement(name="TDate", type="Customweb_EMSeCommerce_Stubs_Com_IpgOnline_Ipgapi_Schemas_A1_GetExternalTransactionStatus_TDate", namespace="http://ipg-online.com/ipgapi/schemas/a1")
	 * @var Customweb_EMSeCommerce_Stubs_Com_IpgOnline_Ipgapi_Schemas_A1_GetExternalTransactionStatus_TDate
	 */
	private $tDate;
	...
	public static function _() {
		$i = new Customweb_EMSeCommerce_Stubs_Com_IpgOnline_Ipgapi_Schemas_A1_GetExternalTransactionStatus();
		return $i;
	}
	/**
	 ...
	 * 
	 * @return Customweb_EMSeCommerce_Stubs_Com_IpgOnline_Ipgapi_Schemas_A1_GetExternalTransactionStatus_TDate
	 */
	 ...
	 * 
	 * @param Customweb_EMSeCommerce_Stubs_Com_IpgOnline_Ipgapi_Schemas_A1_GetExternalTransactionStatus_TDate $tDate
	 * @return Customweb_EMSeCommerce_Stubs_Com_IpgOnline_Ipgapi_Schemas_A1_GetExternalTransactionStatus
	 */
	public function setTDate($tDate){
		if ($tDate instanceof Customweb_EMSeCommerce_Stubs_Com_IpgOnline_Ipgapi_Schemas_A1_GetExternalTransactionStatus_TDate) {
			$this->tDate = $tDate;
		}
		else {
			throw new BadMethodCallException("Type of argument tDate must be Customweb_EMSeCommerce_Stubs_Com_IpgOnline_Ipgapi_Schemas_A1_GetExternalTransactionStatus_TDate.");
		}
		return $this;
	}
