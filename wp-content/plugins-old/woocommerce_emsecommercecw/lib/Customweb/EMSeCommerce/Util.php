...
/**
 * This util class some basic functions for EMSeCommerce.
 *
 * @author Nico Eigenmann
 *
 */
final class Customweb_EMSeCommerce_Util {
	...
	private static function getClientCertificate($path){
	...
	public static function setTxTypeForPaymentMethod($paymentMethod, $txType, Customweb_EMSeCommerce_Stubs_Com_IpgOnline_Ipgapi_Schemas_V1_Transaction $ipgTransaction){
		...
		switch (strtolower($paymentMethodName)) {
			...
			case 'masterpass':
				$type = null;
				switch ($txType) {
					case Customweb_EMSeCommerce_IConstants::OPERATION_AUTHORISATION:
						$type = Customweb_EMSeCommerce_Stubs_Com_IpgOnline_Ipgapi_Schemas_V1_CreditCardTxType_Type::PREAUTH();
						break;
					case Customweb_EMSeCommerce_IConstants::OPERATION_CAPTURE:
						$type = Customweb_EMSeCommerce_Stubs_Com_IpgOnline_Ipgapi_Schemas_V1_CreditCardTxType_Type::POSTAUTH();
						break;
					case Customweb_EMSeCommerce_IConstants::OPERATION_CANCEL:
						$type = Customweb_EMSeCommerce_Stubs_Com_IpgOnline_Ipgapi_Schemas_V1_CreditCardTxType_Type::VOID();
						break;
					case Customweb_EMSeCommerce_IConstants::OPERATION_REFUND:
						$type = Customweb_EMSeCommerce_Stubs_Com_IpgOnline_Ipgapi_Schemas_V1_CreditCardTxType_Type::CONSTANT_RETURN();
						break;
					case Customweb_EMSeCommerce_IConstants::OPERATION_SALE:
						$type = Customweb_EMSeCommerce_Stubs_Com_IpgOnline_Ipgapi_Schemas_V1_CreditCardTxType_Type::SALE();
						break;
					default:
						break;
				}
				$ipgTransaction->setCreditCardTxType(
						Customweb_EMSeCommerce_Stubs_Com_IpgOnline_Ipgapi_Schemas_V1_CreditCardTxType::_()->setType($type));
				break;
			...
			case 'directdebitssepa':
				...
				switch ($txType) {
					case Customweb_EMSeCommerce_IConstants::OPERATION_REFUND:
						$type = Customweb_EMSeCommerce_Stubs_Com_IpgOnline_Ipgapi_Schemas_V1_DE_DirectDebitTxType_Type::CONSTANT_RETURN();
						break;
					case Customweb_EMSeCommerce_IConstants::OPERATION_SALE:
						$type = Customweb_EMSeCommerce_Stubs_Com_IpgOnline_Ipgapi_Schemas_V1_DE_DirectDebitTxType_Type::SALE();
						break;
					default:
						break;
				}
				$ipgTransaction->setDE_DirectDebitTxType(
						Customweb_EMSeCommerce_Stubs_Com_IpgOnline_Ipgapi_Schemas_V1_DE_DirectDebitTxType::_()->setType($type));
				break;
			case 'clickandbuy':
				$type = null;
				switch ($txType) {
					case Customweb_EMSeCommerce_IConstants::OPERATION_CAPTURE:
						$type = Customweb_EMSeCommerce_Stubs_Com_IpgOnline_Ipgapi_Schemas_V1_ClickandBuyTxType_Type::POSTAUTH();
						break;
					case Customweb_EMSeCommerce_IConstants::OPERATION_CANCEL:
						$type = Customweb_EMSeCommerce_Stubs_Com_IpgOnline_Ipgapi_Schemas_V1_ClickandBuyTxType_Type::VOID();
						break;
					case Customweb_EMSeCommerce_IConstants::OPERATION_REFUND:
						$type = Customweb_EMSeCommerce_Stubs_Com_IpgOnline_Ipgapi_Schemas_V1_ClickandBuyTxType_Type::CONSTANT_RETURN();
						break;
					default:
						break;
				}
				$ipgTransaction->setClickandBuyTxType(
						Customweb_EMSeCommerce_Stubs_Com_IpgOnline_Ipgapi_Schemas_V1_ClickandBuyTxType::_()->setType($type));
				break;
			case 'paypal':
				$type = null;
				switch ($txType) {
					case Customweb_EMSeCommerce_IConstants::OPERATION_CAPTURE:
						$type = Customweb_EMSeCommerce_Stubs_Com_IpgOnline_Ipgapi_Schemas_V1_PayPalTxType_Type::POSTAUTH();
						break;
					case Customweb_EMSeCommerce_IConstants::OPERATION_CANCEL:
						$type = Customweb_EMSeCommerce_Stubs_Com_IpgOnline_Ipgapi_Schemas_V1_PayPalTxType_Type::VOID();
						break;
					case Customweb_EMSeCommerce_IConstants::OPERATION_REFUND:
						$type = Customweb_EMSeCommerce_Stubs_Com_IpgOnline_Ipgapi_Schemas_V1_PayPalTxType_Type::CONSTANT_RETURN();
						break;
					default:
						break;
				}
				$ipgTransaction->setPayPalTxType(
						Customweb_EMSeCommerce_Stubs_Com_IpgOnline_Ipgapi_Schemas_V1_PayPalTxType::_()->setType($type));
				break;
			...
			case 'klarnainstallments':
				...
				switch ($txType) {
					case Customweb_EMSeCommerce_IConstants::OPERATION_AUTHORISATION:
						$type = Customweb_EMSeCommerce_Stubs_Com_IpgOnline_Ipgapi_Schemas_V1_KlarnaTxType_Type::PREAUTH();
						break;
					case Customweb_EMSeCommerce_IConstants::OPERATION_CAPTURE:
						$type = Customweb_EMSeCommerce_Stubs_Com_IpgOnline_Ipgapi_Schemas_V1_KlarnaTxType_Type::POSTAUTH();
						break;
					case Customweb_EMSeCommerce_IConstants::OPERATION_CANCEL:
						$type = Customweb_EMSeCommerce_Stubs_Com_IpgOnline_Ipgapi_Schemas_V1_KlarnaTxType_Type::VOID();
						break;
					case Customweb_EMSeCommerce_IConstants::OPERATION_REFUND:
						$type = Customweb_EMSeCommerce_Stubs_Com_IpgOnline_Ipgapi_Schemas_V1_KlarnaTxType_Type::CONSTANT_RETURN();
						break;
					default:
						break;
				}
				$ipgTransaction->setKlarnaTxType(Customweb_EMSeCommerce_Stubs_Com_IpgOnline_Ipgapi_Schemas_V1_KlarnaTxType::_()->setType($type));
				break;
	...
	public static function getCertificate(Customweb_EMSeCommerce_Configuration $config, $isMoto){
		$certificatePath = '';
	
		if ($isMoto) {
			if ($config->isTestMode()) {
				$folder = dirname(__FILE__) . '/Certificates/MoTo/Test/';
				$certificatePath = self::getClientCertificate($folder);
			}
	...
	public static function getOrderAppliedSchema(Customweb_Payment_Authorization_ITransaction $transaction, Customweb_EMSeCommerce_Configuration $configuration){
