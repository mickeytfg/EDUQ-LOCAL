...
require_once 'Customweb/EMSeCommerce/Method/DefaultMethod.php';
 ...
 */
abstract class Customweb_EMSeCommerce_Method_Klarna_Abstract extends Customweb_EMSeCommerce_Method_DefaultMethod {
	 ...
	 */
	protected function getIPGBasketObject($items, Customweb_EMSeCommerce_Authorization_Transaction $transaction, $feeExtra, $forceFee){
		$basket = Customweb_EMSeCommerce_Stubs_Com_IpgOnline_Ipgapi_Schemas_V1_Basket::_();
		...
		foreach ($items as $item) {
			...
			$basketItem = Customweb_EMSeCommerce_Stubs_Com_IpgOnline_Ipgapi_Schemas_V1_Basket_Item::_();
			// @formatter:off
			$basketItem->setID(Customweb_EMSeCommerce_Stubs_Com_IpgOnline_Ipgapi_Schemas_V1_String128max::_()->set(Customweb_Util_String::substrUtf8($item->getSku(), 0, 128)))
			->setDescription(Customweb_EMSeCommerce_Stubs_Com_IpgOnline_Ipgapi_Schemas_V1_String128max::_()->set(Customweb_Util_String::substrUtf8($item->getName(), 0, 128)))
			->setQuantity($quantity)
			->setChargeTotal(Customweb_EMSeCommerce_Stubs_Com_IpgOnline_Ipgapi_Schemas_V1_ItemAmountValueType::_()
				->set(Customweb_Util_Currency::formatAmount($total, $currencyCode)))
			->setSubTotal(Customweb_EMSeCommerce_Stubs_Com_IpgOnline_Ipgapi_Schemas_V1_ItemAmountValueType::_()
					->set(Customweb_Util_Currency::formatAmount($sub, $currencyCode)))
			->setValueAddedTax(Customweb_EMSeCommerce_Stubs_Com_IpgOnline_Ipgapi_Schemas_V1_ItemAmountValueType::_()
					->set(Customweb_Util_Currency::formatAmount($tax, $currencyCode)))
			->setCurrency(Customweb_EMSeCommerce_Stubs_Com_IpgOnline_Ipgapi_Schemas_V1_CurrencyType::_()->set($currencyCode))
			->setDeliveryAmount(Customweb_EMSeCommerce_Stubs_Com_IpgOnline_Ipgapi_Schemas_V1_ItemAmountValueType::_()->set(0));
			// @formatter:on
		...
		if (Customweb_Util_Currency::compareAmount($shippingTotal, 0, $transaction->getCurrencyCode()) > 0) {
			...
			$shippingItem = Customweb_EMSeCommerce_Stubs_Com_IpgOnline_Ipgapi_Schemas_V1_Basket_Item::_();
			// @formatter:off
			$shippingItem->setID(Customweb_EMSeCommerce_Stubs_Com_IpgOnline_Ipgapi_Schemas_V1_String128max::_()->set('IPG_SHIPPING'))
				->setDescription(Customweb_EMSeCommerce_Stubs_Com_IpgOnline_Ipgapi_Schemas_V1_String128max::_()->set(Customweb_Util_String::substrUtf8($shippingName, 0, 128)))
				->setQuantity(1)
				->setChargeTotal(Customweb_EMSeCommerce_Stubs_Com_IpgOnline_Ipgapi_Schemas_V1_ItemAmountValueType::_()
		...
		if ($feeExtra && ($forceFee || Customweb_Util_Currency::compareAmount($feeTotal, 0, $currencyCode) > 0)) {
			$feeItem = Customweb_EMSeCommerce_Stubs_Com_IpgOnline_Ipgapi_Schemas_V1_Basket_Item::_();
			// @formatter:off
			$feeItem->setID(Customweb_EMSeCommerce_Stubs_Com_IpgOnline_Ipgapi_Schemas_V1_String128max::_()->set('IPG_HANDLING'))
				->setDescription(Customweb_EMSeCommerce_Stubs_Com_IpgOnline_Ipgapi_Schemas_V1_String128max::_()->set(Customweb_Util_String::substrUtf8($feeName, 0, 128)))
				->setQuantity(1)
				->setChargeTotal(Customweb_EMSeCommerce_Stubs_Com_IpgOnline_Ipgapi_Schemas_V1_ItemAmountValueType::_()
	 ...
	 */
	protected function getBillingAddressObject(Customweb_EMSeCommerce_Authorization_Transaction $transaction, array $formData){
		...
		$billingObject = Customweb_EMSeCommerce_Stubs_Com_IpgOnline_Ipgapi_Schemas_V1_Billing::_();
		...
		$billingObject->setFirstname(
				Customweb_EMSeCommerce_Stubs_Com_IpgOnline_Ipgapi_Schemas_V1_String48max::_()->set($billingAddress->getFirstName()));
		$billingObject->setSurname(
				Customweb_EMSeCommerce_Stubs_Com_IpgOnline_Ipgapi_Schemas_V1_String48max::_()->set($billingAddress->getLastName()));
		
		$country = $billingAddress->getCountryIsoCode();
		
		$billingObject->setCity(Customweb_EMSeCommerce_Stubs_Com_IpgOnline_Ipgapi_Schemas_V1_String96max::_()->set($billingAddress->getCity()));
		$billingObject->setZip(
				Customweb_EMSeCommerce_Stubs_Com_IpgOnline_Ipgapi_Schemas_V1_String24max::_()->set($billingAddress->getPostCode()));
		$billingObject->setCountry(
				Customweb_EMSeCommerce_Stubs_Com_IpgOnline_Ipgapi_Schemas_V1_String32max::_()->set(
		...
		$billingObject->setEmail(Customweb_EMSeCommerce_Stubs_Com_IpgOnline_Ipgapi_Schemas_V1_String64max::_()->set($email));
		
		$state = trim($billingAddress->getState());
		if (!empty($state)) {
			$billingObject->setState(Customweb_EMSeCommerce_Stubs_Com_IpgOnline_Ipgapi_Schemas_V1_String96max::_()->set($state));
		}
		
		if (strtoupper($billingAddress->getCountryIsoCode()) != 'AT') {
			$billingObject->setStreetName(
					Customweb_EMSeCommerce_Stubs_Com_IpgOnline_Ipgapi_Schemas_V1_String84max::_()->set($splitted['street']));
			$billingObject->setHouseNumber(
					Customweb_EMSeCommerce_Stubs_Com_IpgOnline_Ipgapi_Schemas_V1_String6max::_()->set($splitted['street-number']));
		}
		else {
			$billingObject->setStreetName(
					Customweb_EMSeCommerce_Stubs_Com_IpgOnline_Ipgapi_Schemas_V1_String84max::_()->set($billingAddress->getStreet()));
		}
		...
		if (!empty($phone)) {
			$billingObject->setPhone(Customweb_EMSeCommerce_Stubs_Com_IpgOnline_Ipgapi_Schemas_V1_String32max::_()->set($phone));
		}
		
		if (!empty($mobile)) {
			$billingObject->setMobilePhone(Customweb_EMSeCommerce_Stubs_Com_IpgOnline_Ipgapi_Schemas_V1_String32max::_()->set($mobile));
		}
		...
		if (in_array(strtoupper($billingAddress->getCountryIsoCode()), array(
			...
			if ($dateOfBirth instanceof DateTime) {
				$billingObject->setBirthDate(Customweb_EMSeCommerce_BirthDateFormat::_($dateOfBirth));
			}
			else {
				throw new Customweb_Payment_Exception_PaymentErrorException(
						new Customweb_Payment_Authorization_ErrorMessage(Customweb_I18n_Translation::__("Please enter a valid day of birth."),
			...
			if ($gender == 'female') {
				$billingObject->setGender(Customweb_EMSeCommerce_Stubs_Com_IpgOnline_Ipgapi_Schemas_V1_GenderType::FEMALE());
			}
			elseif ($gender == 'male') {
				$billingObject->setGender(Customweb_EMSeCommerce_Stubs_Com_IpgOnline_Ipgapi_Schemas_V1_GenderType::MALE());
			}
			else {
				throw new Customweb_Payment_Exception_PaymentErrorException(
		...
		if (strtoupper($billingAddress->getCountryIsoCode()) == 'NL') {
			...
			if (!empty($streetAddition)) {
				$billingObject->setHouseExtension(
						Customweb_EMSeCommerce_Stubs_Com_IpgOnline_Ipgapi_Schemas_V1_String6max::_()->set(
		...
		if (in_array(strtoupper($billingAddress->getCountryIsoCode()), array(
			...
			if (!empty($socialNumber)) {
				$billingObject->setPersonalNumber(
						Customweb_EMSeCommerce_Stubs_Com_IpgOnline_Ipgapi_Schemas_V1_String20max::_()->set($socialNumber));
			}
			else {
				throw new Customweb_Payment_Exception_PaymentErrorException(
	 ...
	 */
	protected function getShippingAddressObject(Customweb_EMSeCommerce_Authorization_Transaction $transaction){
		$shippingAddress = $transaction->getTransactionContext()->getOrderContext()->getShippingAddress();
		$shippingObject = Customweb_EMSeCommerce_Stubs_Com_IpgOnline_Ipgapi_Schemas_V1_Shipping::_();
		
		$shippingObject->setName(
				Customweb_EMSeCommerce_Stubs_Com_IpgOnline_Ipgapi_Schemas_V1_String96max::_()->set(
						$shippingAddress->getFirstName() . ' ' . $shippingAddress->getLastName()));
		$shippingObject->setAddress1(
				Customweb_EMSeCommerce_Stubs_Com_IpgOnline_Ipgapi_Schemas_V1_String96max::_()->set($shippingAddress->getStreet()));
		$shippingObject->setCity(
				Customweb_EMSeCommerce_Stubs_Com_IpgOnline_Ipgapi_Schemas_V1_String96max::_()->set($shippingAddress->getCity()));
		$shippingObject->setZip(
				Customweb_EMSeCommerce_Stubs_Com_IpgOnline_Ipgapi_Schemas_V1_String24max::_()->set($shippingAddress->getPostCode()));
	 ...
	 */
	protected function createServerRequest(Customweb_EMSeCommerce_Authorization_Transaction $transaction, array $formData, $pClass){
		...
		$currency = Customweb_EMSeCommerce_Util::getNumericCurrencyCode(
				$transaction->getTransactionContext()->getOrderContext()->getCurrencyCode());
		$orderId = Customweb_EMSeCommerce_Util::getOrderAppliedSchema($transaction, $this->getGlobalConfiguration());
		
		$ipgTransaction = Customweb_EMSeCommerce_Stubs_Com_IpgOnline_Ipgapi_Schemas_V1_TransactionElement::_();
		$ipgTransaction->setKlarnaPClassID($pClass);
		$ipgTransaction->setKlarnaTxType(
				Customweb_EMSeCommerce_Stubs_Com_IpgOnline_Ipgapi_Schemas_V1_KlarnaTxType::_()->setType(
						Customweb_EMSeCommerce_Stubs_Com_IpgOnline_Ipgapi_Schemas_V1_KlarnaTxType_Type::PREAUTH()));
		...
		$ipgPayment->setCurrency(Customweb_EMSeCommerce_Stubs_Com_IpgOnline_Ipgapi_Schemas_V1_CurrencyType::_()->set($currency))->setChargeTotal(
				Customweb_EMSeCommerce_Stubs_Com_IpgOnline_Ipgapi_Schemas_V1_AmountValueType::_()->set($formattedAmount));
		...
		$ipgTransactionDetails->setOrderId(Customweb_EMSeCommerce_Stubs_Com_IpgOnline_Ipgapi_Schemas_V1_String100max::_()->set($orderId));
		$ipgTransactionDetails->setTransactionOrigin(Customweb_EMSeCommerce_Stubs_Com_IpgOnline_Ipgapi_Schemas_V1_TransactionOrigin::ECI());
		
		try {
			$ip = $this->getContainer()->getBean('Customweb_Core_Http_IRequest')->getRemoteAddress();
			$ipgTransactionDetails->setIp(Customweb_EMSeCommerce_Stubs_Com_IpgOnline_Ipgapi_Schemas_V1_Ip::_()->set($ip));
		}
		catch (Exception $e) {
			throw new Customweb_Payment_Exception_PaymentErrorException(
					new Customweb_Payment_Authorization_ErrorMessage(
		...
		$ipgOrderRequest = Customweb_EMSeCommerce_Stubs_Com_IpgOnline_Ipgapi_Schemas_Ipgapi_IPGApiOrderRequest::_();
