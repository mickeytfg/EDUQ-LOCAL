...
require_once 'Customweb/Xml/Type.php';
require_once 'Customweb/Annotation/UnifiedPropertyReflector.php';
require_once 'Customweb/Xml/Binding/Reflection/AbstractItem.php';
